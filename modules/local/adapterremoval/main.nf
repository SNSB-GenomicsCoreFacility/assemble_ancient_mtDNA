process ADAPTERREMOVAL {
    ...
    if ( !single_end   && !params.skip_collapse && !params.skip_trim  && !params.mergedonly && !params.preserve5p ) {
    """
    mkdir -p output
    ...
    } else if (!single_end && !params.skip_collapse && !params.skip_trim  && !params.mergedonly && params.preserve5p) {
    """
    mkdir -p output
    ...
    } else if ( !single_end   && !params.skip_collapse && params.skip_trim && !params.mergedonly ) {
    """
    mkdir -p output
    ...
    } else if ( !single_end   && params.skip_collapse && !params.skip_trim ) {
    """
    mkdir -p output
    ...
    """
    } else if ( single_end  && !params.skip_trim ) {
